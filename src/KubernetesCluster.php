 ...
 * @method \RenokiCo\PhpK8s\Kinds\K8sGatewayClass gatewayClass(array $attributes = [])
 * @method \RenokiCo\PhpK8s\Kinds\K8sGatewayClass getGatewayClassByName(string $name, string $namespace = 'default', array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllGatewayClassesFromAllNamespaces(array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllGatewayClasses(string $namespace = 'default', array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\Kinds\K8sGateway gateway(array $attributes = [])
 * @method \RenokiCo\PhpK8s\Kinds\K8sGateway getGatewayByName(string $name, string $namespace = 'default', array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllGatewaysFromAllNamespaces(array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllGateways(string $namespace = 'default', array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\Kinds\K8sHTTPRoute httpRoute(array $attributes = [])
 * @method \RenokiCo\PhpK8s\Kinds\K8sHTTPRoute getHttpRouteByName(string $name, string $namespace = 'default', array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllHttpRoutesFromAllNamespaces(array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllHttpRoutes(string $namespace = 'default', array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\Kinds\K8sGRPCRoute grpcRoute(array $attributes = [])
 * @method \RenokiCo\PhpK8s\Kinds\K8sGRPCRoute getGrpcRouteByName(string $name, string $namespace = 'default', array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllGrpcRoutesFromAllNamespaces(array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllGrpcRoutes(string $namespace = 'default', array $query = ['pretty' => 1])
