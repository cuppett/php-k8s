 ...
 * @method \RenokiCo\PhpK8s\Kinds\K8sLease lease(array $attributes = [])
 * @method \RenokiCo\PhpK8s\Kinds\K8sLease getLeaseByName(string $name, string $namespace = 'default', array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllLeasesFromAllNamespaces(array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllLeases(string $namespace = 'default', array $query = ['pretty' => 1])
