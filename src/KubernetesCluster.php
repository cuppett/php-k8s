 ...
 * @method \RenokiCo\PhpK8s\Kinds\K8sVolumeSnapshot volumeSnapshot(array $attributes = [])
 * @method \RenokiCo\PhpK8s\Kinds\K8sVolumeSnapshot getVolumeSnapshotByName(string $name, string $namespace = 'default', array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllVolumeSnapshotsFromAllNamespaces(array $query = ['pretty' => 1])
 * @method \RenokiCo\PhpK8s\ResourcesList getAllVolumeSnapshots(string $namespace = 'default', array $query = ['pretty' => 1])
