...
class EksTokenProvider extends TokenProvider
{
    ...
    protected int $tokenTtl = 60; // 60 seconds (AWS CLI default)
    ...
    public function refresh(): void
    {
        ...
        $endpoint = "https://sts.{$this->region}.amazonaws.com/?Action=GetCallerIdentity&Version=2011-06-15";
    ...
    protected function getCredentials(): \Aws\Credentials\CredentialsInterface
    {
        ...
        if ($this->roleArn) {
            ...
            $result = $stsClient->assumeRole([
                ...
                'RoleSessionName' => 'php-k8s-session',
            ]);
