...
Starting with OpenShift 4.11, use the TokenRequest API for bound tokens. See [ServiceAccount TokenRequest](/authentication/service-account-token).
...
OpenShift Routes require a custom resource definition. See [Custom Resources (CRDs)](/guide/custom-resources).
...
- [Exec Credential Plugin](/authentication/exec-credential) - Standard Kubernetes exec auth
- [ServiceAccount TokenRequest](/authentication/service-account-token) - Bound service account tokens
- [AWS EKS Authentication](/authentication/eks) - Native EKS authentication
