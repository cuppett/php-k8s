...
See the [Server Side Apply Guide](/guide/usage/server-side-apply) for more details.
...
- [Server Side Apply](/guide/usage/server-side-apply) - Declarative updates with field ownership
- [CRUD Operations](/guide/usage/crud-operations) - Traditional update method
- [Scaling](/guide/usage/scaling) - Scale resources
