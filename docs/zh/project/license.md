...
- In the [LICENSE file](https://github.com/cuppett/php-k8s/blob/main/LICENSE) in the repository
...
See [Upstream Attribution](/project/upstream-attribution) for full details.
...
- Review the [Apache License 2.0 FAQ](https://www.apache.org/foundation/license-faq.html)
