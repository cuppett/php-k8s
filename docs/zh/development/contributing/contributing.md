...
2. Clone your fork
3. Set up development environment (see [Development Setup](/development/contributing/setup))
...
- [Development Setup](/development/contributing/setup) - Set up dev environment
