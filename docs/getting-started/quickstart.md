...
- PHP K8s installed (see [Installation](/getting-started/installation))
...
- [Authentication](/getting-started/authentication) - Configure secure cluster access
- [Configuration](/getting-started/configuration) - Advanced configuration options
- [CRUD Operations](/guide/crud-operations) - Deep dive into resource management
