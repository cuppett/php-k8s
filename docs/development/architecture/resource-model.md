...
- [Trait Composition](/development/architecture/trait-composition) - Detailed trait documentation
- [Cluster Operations](/development/architecture/cluster-operations) - How resources interact with cluster
- [Extensibility](/development/architecture/extensibility) - Extending the resource model
