...
- [Server Side Apply Guide](/guide/usage/server-side-apply) - Complete documentation with examples
- [JSON Patch](/development/api-reference/patches/json-patch) - Surgical updates
- [JSON Merge Patch](/development/api-reference/patches/json-merge-patch) - Simple merge updates
- [Patching Guide](/guide/usage/patching) - Overview of patching methods
