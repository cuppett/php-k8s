...
- **Pod Logs** - Stream logs from containers (see [Exec & Logs](/guide/exec-logs))
- **Events** - Watch Event resources for cluster activity

## Next Steps

- [Exec & Logs](/guide/exec-logs) - Execute commands and stream logs
- [Patching](/guide/patching) - Update resources in response to changes
- [Scaling](/guide/scaling) - Scale resources based on watch events
