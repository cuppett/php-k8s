...
- [CRUD Operations](/guide/crud-operations) - Traditional create/update/delete
- [Server Side Apply API Reference](/api-reference/patches/server-side-apply) - Detailed API documentation
