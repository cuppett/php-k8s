...
See [Resource Traits](/api-reference/traits/resource-traits) for complete list.
...
- [Resource Model](/architecture/resource-model) - Overall architecture
- [Resource Traits](/api-reference/traits/resource-traits) - Available traits
