...
This fork is based on the excellent work of [Alex Renoki](https://github.com/rennokki) and contributors to the [renoki-co/php-k8s](https://github.com/renoki-co/php-k8s) project.
...
- **Original Author**: Alex Renoki ([@rennokki](https://github.com/rennokki))
- **License**: Apache-2.0
...
Both the upstream project and this fork are released under the Apache-2.0 License. See the [License](/project/license) page for full details.
