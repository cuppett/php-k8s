...
2. **PHP 8.3+ Modernization** - Leverage modern PHP features
...
**This Fork**:
- Tests against Kubernetes 1.36.4, 1.37.0
...
1. **PHP Version** - Requires PHP 8.3+ (upstream supports 8.0+)
...
- You're using PHP 8.3+ and want modern features
...
1. Support latest PHP versions (8.3, 8.4, 8.5+)
